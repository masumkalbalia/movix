...
<head>
    ...
    <link rel="shortcut icon" href="./favicon.png/android-chrome-512x512.png" type="image/x-icon">
    ...
    <div id="main">
        ...
        <div id="page2" data-scroll data-scroll-speed="-2">
            <div id="video-container">
                ...
                <img src="image/63511c3498696366719608.png" alt="">
                <video  muted loop src="video/Obys Showreel 2022.mp4"></video>
            </div>
        </div>
        <div id="page3" data-scroll data-scroll-speed="-2">
            <h1>OUR PROJECTS</h1>
            <div class="underline"></div>
            <div id="image-div-container">
                <div class="image-div">
                    <img src="image/orce.jpeg" alt="">
                    <img src="image/69 charger.jpeg" alt="">
                </div>
                <div class="image-div">
                    <img src="image/GoOnlineTools-image-downloader (2).png" alt="">
                    <img src="image/House.jpeg" alt="">
                </div>
                <div class="page3-circle1">
                    <svg class="button__arrow" viewBox="0 0 91 118" fill="none">
                        ...
                        <div class="circle-in">
                            <p>we ae thrilled to have on board. we have you enjoed the projects ❤</p>
                        </div>
                </div>
                ...
                <div class="image-div">
                    <img src="image/GoOnlineTools-image-downloader (3).png" alt="">
                    <img src="image/69 charger.jpeg" alt="">
                </div>
                <div class="image-div">
                    <img src="image/GoOnlineTools-image-downloader.png" alt="">
                    <img src="image/69 charger.jpeg" alt="">
                </div>
            </div>
        </div>
        <div id="page4" data-scroll data-scroll-speed="-2">
            <div id="page4-content">
                <h1>About obys</h1>
                <div class="underline"></div>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae ut nisi earum fuga, totam accusamus. Autem porro placeat nisi perspiciatis molestias tenetur, libero animi corporis.</p>
                    <div id="page4-flex">
                        <img src="image/csm_13-DP02820-2023BC.1002673_CO_2ab53ad47e.jpg" alt="">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus architecto temporibus perferendis assumenda deserunt sunt nisi fuga ut laudantium mollitia voluptate, at, iure illo facilis.</p>
                    </div>
                    <div id="page4-blue-div">
                        <div class="blue-div-elem">
                            <h4>Awwwards x16</h4>
                            <h3>SOTM, SOTD and Honrable Mentions</h3>
                        </div>
                        <div class="blue-div-elem">
                            <h4>Awwwards x16</h4>
                            <h3>SOTM, SOTD and Honrable Mentions</h3>
        ...
        <div id="page5" data-scroll data-scroll-speed="-2">
            <div class="elem5">
                <h1><span>Sport</span> - Fasion - Technology -</h1>
                <h1>Sport - <span>Fasion</span> - Technology -</h1>
            </div>
            <div class="elem6">
                <h1>Science - Partners - <span>Travel</span> -</h1>
                <h1>Science - <span>artners</span> - Travel -</h1>
            </div>
            <div class="elem5">
                <h1><span>Sport</span> - Fasion - Technology -</h1>
                <h1>Sport - <span>Fasion</span> - Technology -</h1>
        ...
        <div id="footer" data-scroll data-scroll-speed="-2">
            <h1>let's create</h1>
            <div class="underline"></div>
            <div id="footer-div">
                <div class="box">
